...
namespace GmailQuickstart
{
    class Program : IRobot
    {
        ...
        static int[] _fields = { eesFields.Default.email_cuerpo, eesFields.Default.email_asunto, eesFields.Default.estado_error, eesFields.Default.id_est_hijo, eesFields.Default.id_est_padre, eesFields.Default.fields, eesFields.Default.fecha_hora_de_email, eesFields.Default.email_de, eesFields.Default.email_cc };
