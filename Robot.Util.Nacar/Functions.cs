...
namespace Robot.Util.Nacar
{
    public class Functions
    {
        ...
        public FunctionalDomains<List<DomainValue>> GetDomainValuesByParameters(Func<FunctionalDomains<List<DomainValue>>, FunctionalDomains<List<DomainValue>>> SearchDomain, string nameFunctionalDomain, string[,] parametersQueryable, int page = 1, int bufferSize = 100)
        {
            ...
            FunctionalDomains<List<DomainValue>> objSearch = FunctionalDomains<List<DomainValue>>.
                CreateFunctionalDomainsSearch(nameFunctionalDomain, parameters, page, bufferSize);
